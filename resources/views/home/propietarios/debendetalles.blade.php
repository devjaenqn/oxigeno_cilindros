      ...
      <div class="modal-body">
        <form action="" class="form-horizontal">
          ...
          <div class="form-group row mb-1 mt-1">
            ...
            <div class="col-md-9">
              <input id="numero_comprobante" type="text" name="numero_comprobante" placeholder="000000000" class="form-control pt-1 pr-2 pb-1 pl- 2 text-select">
            </div>
            <div class="col">
              <button type="button" title="Verificar" class="btn btn-sm btn-success"><i class="fa fa-check"></i></button>
            </div>
          </div>
        </form>
      </div>
