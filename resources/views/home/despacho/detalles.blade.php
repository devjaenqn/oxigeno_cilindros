    ...
    <div class="col-lg-24">
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Despacho - Detalles
                  ...
                  {{-- <div class="card card-accent-success">
                      ...
                      <div class="card-body"> --}}
                        ...
                        <div class="form-group row mb-1 mt-1">
                          ...
                          <div class="col-md-18">
                            <p class="form-control-static m-0 ">{{ $despacho->observacion }}</p>
                          </div>
                        </div>
                    ...
                    <table class="table table-responsive-sm table-sm">
                      ...
                      <tbody>
                        @foreach ($cilindros as $cil)
                          <tr >
                            <td><a href="{{ url('home/cilindro/'.$cil->cilindro->cil_id) }}" class="none-text-decoration">{{ $cil->cilindro->serie }}</a></td>
