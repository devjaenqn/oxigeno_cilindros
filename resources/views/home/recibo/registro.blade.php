      ...
      <div class="card">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                          <div class="form-group row mb-1 mt-1">
                            ...
                            <div class="col-md-16">
                              <input class="form-control pt-1 pr-2 pb-1 pl- 2 text-select" id="cilindro_th"  type="text" name="cilindro_th" v-model="cilindro.serie" placeholder="00000000">
                              {{-- <span class="help-block" ifs="error.propietario">Seleccione un propietario</span> --}}
                            </div>
                          </div>
        ...
        <div class="card-footer">
          <form class="form-horizontal"  @submit.prevent="frmOnSubmit_frmRegistro" id="frm_registro_recibo">
            <button class="btn btn-sm btn-primary" type="submit">
              <i class="fa fa-check"></i> {{ $edit ? 'Actualizar' : 'Registrar recibo' }}</button>
