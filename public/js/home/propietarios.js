...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__listar__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__listar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__listar__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__registro__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__registro___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__registro__);
...
var router = new __WEBPACK_IMPORTED_MODULE_2_vue_router__["a" /* default */]({
  // mode: 'history',
  routes: [{ path: '/', component: __WEBPACK_IMPORTED_MODULE_0__listar___default.a }, { path: '/registro', component: __WEBPACK_IMPORTED_MODULE_1__registro___default.a }, { path: '/:id/editar', component: __WEBPACK_IMPORTED_MODULE_1__registro___default.a, name: 'editar' }]
});

// Vue.component('select-tipo-docs', {
//   template: '#tipo_docs',
...
Component.options.__file = "resources\\assets\\js\\views\\home\\propietarios\\listar.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2b7bf618", Component.options)
  } else {
    hotAPI.reload("data-v-2b7bf618", Component.options)
  }
...
// var datatable = require("imports?define=>false!datatables.net")(window, $)
// dt(window, $)
var $ = window.jQuery;
...
var render = function() {
  ...
  return _c("div", { staticClass: "col-lg-24" }, [
    _c("div", { staticClass: "card" }, [
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "card-body" }, [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-sm-24" }, [
            _c(
              "form",
              {
                on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2b7bf618", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\views\\home\\propietarios\\registro.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d59bb2d0", Component.options)
  } else {
    hotAPI.reload("data-v-d59bb2d0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
// import axios from 'axios'
/* harmony default export */ __webpack_exports__["default"] = ({
  template: '#tmpl_registro_propietarios',
  data: function data() {
    return {
      edit: false,
      id: 0,
  ...
  methods: {
    ...
    getPropietario: function getPropietario(id) {
      var _this = this;

      axios.get(BASE_URL + '/api/propietarios/' + id).then(function (res) {
        console.log(res.data);
        if (_this.edit && res.data.success) {
          _this.propietario = res.data.data;

          _this.id = _this.propietario.ent_id;
          _this.nombre = _this.propietario.nombre;
          _this.documento = _this.propietario.documento.cod;
          _this.numero = _this.propietario.numero;
          _this.direccion = _this.propietario.direccion;
          _this.referencia = _this.propietario.referencia;
          _this.correo = _this.propietario.correo;
          _this.celular = _this.propietario.telefono;
        }
      }).catch(function (err) {
        console.log(err);
    ...
    getDocumentos: function getDocumentos() {
      ...
      axios.get(BASE_URL + '/api/documentos_identidad').then(function (res) {
        console.log(res.data);
        _this3.documentos = res.data;
      });
    }
  },
  beforeCreate: function beforeCreate() {
    // console.log(this)
    // // this.getDocumentos()
    // this.nombre = 'asdasdasd'
  },
  created: function created() {
    console.log('registro propietarios');
    console.log(this);
    this.getDocumentos();
    if (this.$route.name == 'editar') {
      this.edit = true;
      this.getPropietario(this.$route.params.id);
    }
    return false;
  }
});
